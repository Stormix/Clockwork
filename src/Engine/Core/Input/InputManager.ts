...
export class MouseContext {
  ...
  public constructor(leftDown = false, rightDown = false, position: Vector2) {
...
export class InputManager {
  ...
  private static _leftDown = false
  private static _rightDown = false
  ...
  private static onMouseMove(event: MouseEvent): void {
    ...
    InputManager._mouseX =
      ...
      (1 / InputManager._resolutionScale.x)
    InputManager._mouseY =
      (event.clientY - Math.round(rect.top)) *
      (1 / InputManager._resolutionScale.y)
  }
