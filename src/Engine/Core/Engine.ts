...
export class Engine {
  ...
  public constructor(width?: number, height?: number) {
    this._gameWidth = width ?? 800
    this._gameHeight = height ?? 600
  }
  ...
  public start(game: IGame, elementName?: string): void {
    ...
    const rendererViewportCreateInfo: RendererViewportCreateInfo =
      new RendererViewportCreateInfo()
  ...
  private update(delta: number): void {
    ...
    if (LevelManager.isLoaded && LevelManager.activeLevel?.isLoaded) {
